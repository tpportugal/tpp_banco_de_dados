describe Geometry do
  ...
  context 'distance calculation' do
    ...
    it 'accurately calculates the distances of a route with stops along the line that traversed over itself in the opposite direction' do
      # see https://tpp.pt/documentation/datastore/rome_01_part_1.png
      # and https://tpp.pt/documentation/datastore/rome_01_part_2.png
    ...
    it 'calculates the first stop distance correctly' do
      ...
      # see https://tpp.pt/documentation/datastore/first_stop_correct_distance.png
    ...
    it 'can accurately calculate distances when a stop is repeated.' do
      ...
      # see https://tpp.pt/documentation/datastore/repeated_stop_vta_66.png
    ...
    it 'can accurately calculate distances when a stop matches to a segment before the previous stop\'s matching segment' do
      ...
      # See https://tpp.pt/documentation/datastore/previous_segment_1_sfmta_n~owl.png
      # and https://tpp.pt/documentation/datastore/previous_segment_2_sfmta_n~owl.png
